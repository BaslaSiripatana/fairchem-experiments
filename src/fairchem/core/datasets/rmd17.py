...
from fairchem.core.modules.transforms_rmd17.units import update_units_transform
...
class MD17(LmdbDataset[T]):
    ...
    @classmethod
    def download(cls, args: argparse.Namespace, molecule: str):
...
if __name__ == "__main__":
    ...
    download_parser.set_defaults(func=MD17.download)

    args = parser.parse_args()

    pbar = tqdm(list(MD17.molecules))
    for molecule in pbar:
        pbar.set_description(molecule)
        args.func(args, molecule=molecule)
